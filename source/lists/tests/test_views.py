...
class NewListViewIntegratedTest(TestCase):
    ...
    def test_redirect_after_post(self): # delete - ch 19
    ...
    def test_for_invalid_input_renders_home_template(self): # to be deleted ch 19
    ...
    def test_for_invalid_input_passes_form_to_template(self): # to be deleted ch 19
        response = self.client.post('/lists/new', data={'text': ''})
        self.assertIsInstance(response.context['form'], ItemForm)
